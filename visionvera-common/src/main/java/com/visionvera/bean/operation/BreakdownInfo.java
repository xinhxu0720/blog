...
private static final long serialVersionUID = 1L;
	...
	public String toString() {
		return "BreakdownInfo [id=" + id + ", meetingId=" + meetingId + ", sketch=" + sketch + ", detail=" + detail
				+ ", statusInfo=" + statusInfo + ", visitStatus=" + visitStatus + ", isSolve=" + isSolve
				+ ", isNeedVisit=" + isNeedVisit + ", isVisit=" + isVisit + ", expectVisitTime=" + expectVisitTime
				+ ", actualVisitTime=" + actualVisitTime + ", visitContent=" + visitContent + ", creatTime=" + creatTime
				+ ", lastUpdateTime=" + lastUpdateTime + ", historyCount=" + historyCount + "]";
	}
}
